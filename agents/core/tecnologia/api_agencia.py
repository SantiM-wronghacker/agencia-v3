...
class AgenciaHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # GET /credenciales?proyecto=xxx — listar credenciales de un proyecto
            ...
            try:
                from agencia.agents.herramientas.gestor_credenciales import listar_credenciales_proyecto, listar_plataformas, listar_categorias_plataformas
    ...
    def do_POST(self):
        ...
        # Body: {"proyecto": "...", "plataforma": "...", "credenciales": {...}}
            ...
            try:
                from agencia.agents.herramientas.gestor_credenciales import guardar_credencial
        ...
        # Body: {"proyecto": "...", "tarea": "publicar en facebook"}
            ...
            try:
                from agencia.agents.herramientas.gestor_credenciales import credenciales_faltantes
                proyecto = body.get("proyecto", "")
        ...
        # Body: {"proyecto": "...", "plataforma": "..."}
            ...
            try:
                from agencia.agents.herramientas.gestor_credenciales import eliminar_credencial
        ...
        # Body: {"url": "way2theunknown.com", "proyecto": "way2theunknown"}
            ...
            try:
                from agencia.agents.herramientas.detector_plataforma import analisis_completo
                url = body.get("url", "")
                proyecto = body.get("proyecto", "")
                if not url:
        ...
        # Body: {"descripcion": "...", "proyecto": "way2theunknown", "prioridad": "normal"}
            ...
            if proyecto:
                ...
                try:
                    from agencia.agents.cerebro.llm_router import completar_simple as ia_router
